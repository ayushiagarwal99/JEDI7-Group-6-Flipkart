...
public class SQLQueriesConstant {
		...
		public static final String VIEW_PENDING_ADMISSION_QUERY = "select userId,user.name, password, role, gender, address, studentId from student, user where isApproved = 0 and studentId = userId";
		...
		public static final String ADD_STUDENT="insert into student (studentId,name,department,gradYear,isApproved,isRegistered,isReportGenerated,isPaid) values (?,?,?,?,0,0,0,0)";
