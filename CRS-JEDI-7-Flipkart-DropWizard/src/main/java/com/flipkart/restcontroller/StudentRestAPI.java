...
public class StudentRestAPI {
	...
	public Response make_payment(
			...
			@PathParam("PaymentModeConstant") int P, @HeaderParam("authKey") String authKey) throws ValidationException{
...
//			logger.info("Your transaction id : " + notify.getReferID());
	...
	public Response calculateFee(
			@NotNull
			@QueryParam("studentId") String studentId, @HeaderParam("authKey") String authKey) throws ValidationException, SQLException{
		if(UserAuth.isStudentLogin(authKey) ==null){
			return Response.status(403).entity("Access Denied").build();
		}
